...
- [x] `npm run build` passes for the local landing/Auth/profile candidate; `/profile` is 120 kB and `/workspace`/`/explore` are 224 kB First Load JS after mode-gated Supabase dynamic loading.
