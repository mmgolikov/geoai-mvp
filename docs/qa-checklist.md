...
- [x] CR 10.02 locally proves one scoped Product System v3.2 shell at 1440×900, 1024×900, 768×1024 and 390×844: exact 64 px header, active routes, approved identity, 40/44 px targets, deterministic double captures, no shell/body overlap or horizontal overflow, keyboard focus, Escape/outside-click/route closure and zero serious/critical Axe findings. A byte-identical 20-image body-only before/after comparison covers Workspace, Projects, Explore, Request Access and Profile. **Exact-head GitHub Quality Gate, immutable artifact, Vercel Preview and founder review remain required before Ready-for-review; page bodies and real-user authorization are not covered by this design gate.**
