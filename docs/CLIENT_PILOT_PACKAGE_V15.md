# GeoAI Client Pilot Package v1.5

Date: 2026-06-23

This document describes the v1.5 client pilot framing layer. It is a commercial and delivery narrative for demos, not a production readiness claim.
...
GeoAI deliverables:
- Investment screening workspace configured for the client shortlist
