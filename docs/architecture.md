...
- Workspace comparison, express-result and report-preview surfaces are dynamically loaded. The same local production-build comparison reduced First Load JS from 252 kB to 218 kB (approximately 13.5% gzip); exact-Preview and Core Web Vitals evidence remain open.
