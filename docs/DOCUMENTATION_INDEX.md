...
| POINT_TO_OBJECT_001 V5.1 candidate | [V5.1 Change Request](change-requests/point-to-object-001/experience-v5/POINT_TO_OBJECT_001_V5_1_INTERACTION_FIND_PROFILE_CHANGE_REQUEST.md) and [exact Preview receipt](change-requests/point-to-object-001/experience-v5/RELEASE_POINT_TO_OBJECT_001_V5_1_PREVIEW_RECEIPT_20260904.md) | Exact commit and Ready protected Preview recorded; application CI, focused rendered-browser and founder manual acceptance pending; not merged or released |
...
| POINT_TO_OBJECT_001 V5.1 candidate | Branch `codex/point-to-object-clickable-prototype-v1` and open Draft PR #147 carry exact commit `2124379e62954fd9ef7dfa2fadcdc1c485b888fc`. Protected Preview `dpl_HrJxAKZsjR4rWf26t9c7rkLQpWih` is Ready; the application Quality Gate, focused browser evidence and founder manual acceptance remain pending in the [receipt](change-requests/point-to-object-001/experience-v5/RELEASE_POINT_TO_OBJECT_001_V5_1_PREVIEW_RECEIPT_20260904.md). It is not merged or Production-active; released source pack count-only/disabled, `main`, Production and hosted Supabase unchanged |
