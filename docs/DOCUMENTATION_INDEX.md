...
| POINT_TO_OBJECT_001 V6 active Preview iteration | [Umbrella Change Request](change-requests/point-to-object-001/experience-v6/POINT_TO_OBJECT_001_V6_UMBRELLA_CHANGE_REQUEST.md), [integrated backlog](change-requests/point-to-object-001/experience-v6/POINT_TO_OBJECT_001_V6_INTEGRATED_BACKLOG.md), [exact A-head Preview receipt](change-requests/point-to-object-001/experience-v6/RELEASE_POINT_TO_OBJECT_001_V6_PREVIEW_RECEIPT_20260904.md), [product reconciliation](change-requests/point-to-object-001/experience-v6/POINT_TO_OBJECT_001_V6_REUSE_ADAPT_REPLACE_RETIRE_MATRIX.md), [GeoContext contract](change-requests/point-to-object-001/experience-v6/GEO_CONTEXT_SNAPSHOT_V1_CONTRACT.md), [Scenario Registry](change-requests/point-to-object-001/experience-v6/SCENARIO_REGISTRY_V1_CONTRACT.md), [Decision Record](change-requests/point-to-object-001/experience-v6/DECISION_RECORD_V1_CONTRACT.md), [Decision Render Receipt](change-requests/point-to-object-001/experience-v6/DECISION_RENDER_RECEIPT_V1_CONTRACT.md), [gate sequence](change-requests/point-to-object-001/experience-v6/POINT_TO_OBJECT_001_V6_DEPENDENCY_GATE_SEQUENCE.md), [Build/Buy/Partner research](change-requests/point-to-object-001/experience-v6/GENERATIVE_DEVELOPMENT_BUILD_BUY_PARTNER_RESEARCH_20260904.md) and [21-product / 25-field technical-commercial matrix](change-requests/point-to-object-001/experience-v6/GENERATIVE_DEVELOPMENT_TECHNICAL_COMMERCIAL_MATRIX_20260904.md) | Integrated head A `3f2ca5b...` passed Quality Gate `33915252452` and is Ready as protected Preview `dpl_J98ac...`. Receipt B binds A without self-claiming B evidence; exact B CI/Preview must be recorded externally in Draft PR #147 after B verification. Founder manual acceptance remains pending. No Confluence read-back or mutation was performed in V6, so Hub parity is unverified. Not merged or released |
| POINT_TO_OBJECT_001 V5.1 candidate | [V5.1 Change Request](change-requests/point-to-object-001/experience-v5/POINT_TO_OBJECT_001_V5_1_INTERACTION_FIND_PROFILE_CHANGE_REQUEST.md) and [exact Preview receipt](change-requests/point-to-object-001/experience-v5/RELEASE_POINT_TO_OBJECT_001_V5_1_PREVIEW_RECEIPT_20260904.md) | Verified V5.1 application head `789b197e4dcd3dbd03fc3d4aa594bdcb23ab1794`; docs-only branch head `d85ef69624bc79c50af788c165c0760dcab01c8f` preserves pre-V6 evidence: Quality Gate `33880472031` and Preview `dpl_BH4us5PwSs7yw98JfbG9C1GnZgbz` Ready at [geoai-4thdsrhia-geoaidev.vercel.app](https://geoai-4thdsrhia-geoaidev.vercel.app). Founder manual acceptance pending; not merged or released |
...
2026-09-06 Cycle 04: the [approved iteration](change-requests/point-to-object-001/experience-v6/CYCLE_04_GEOCONTEXT_GENERATOR_CHANGE_REQUEST.md) starts from `d5091f2c62e14936fc0440f396b4cfedfd45f53c`. It covers Profile-owned audience in Find, Create locale/AOI UX fixes, one bounded Wikidata enrichment and site-responsive non-rectangular generation. The [integration receipt](change-requests/point-to-object-001/experience-v6/CYCLE_04_INTEGRATION_RECEIPT.md) records completed source/geometry/UX checks, build 79/79 and ten browser journeys. Exact successor CI/protected Preview readbacks will be recorded in open Draft PR #147 after publication. Prior-cycle receipts remain evidence for their exact heads only; paid live AI and point/AOI semantic parity are not claimed.
...
| Fact | Current value |
| --- | --- |
| Released PR | GitHub PR #113, merged (`Merge PR #113: Product System v3.2.2 correction`) |
...
| POINT_TO_OBJECT_001 V5.1 candidate | Branch `codex/point-to-object-clickable-prototype-v1` and open Draft PR #147 carry verified V5.1 application head `789b197e4dcd3dbd03fc3d4aa594bdcb23ab1794`. The later docs-only branch head is `d85ef69624bc79c50af788c165c0760dcab01c8f`; its pre-V6 evidence is Quality Gate `33880472031` and protected Preview `dpl_BH4us5PwSs7yw98JfbG9C1GnZgbz` Ready at [geoai-4thdsrhia-geoaidev.vercel.app](https://geoai-4thdsrhia-geoaidev.vercel.app). Founder manual acceptance remains pending in the [receipt](change-requests/point-to-object-001/experience-v5/RELEASE_POINT_TO_OBJECT_001_V5_1_PREVIEW_RECEIPT_20260904.md). It is not merged or Production-active; released source pack count-only/disabled, `main`, Production and hosted Supabase unchanged |
| Maturity | Not Production-ready and not pilot-ready |

The full-system audit was merged as PR #97 and remains historical containment evidence. PR #106 is preserved as the prior historical public-demo snapshot; PR #113 / `7f323c4227f2409f3fe2d4d68be48a30176f4e2a` is the current externally verified release. [Current Release State](CURRENT_RELEASE_STATE.md), the [release policy](RELEASE_AUTHORITY_POLICY.json) and [historical snapshot](LAST_VERIFIED_RELEASE_SNAPSHOT.json) govern repository interpretation. Live authority is external post-release GitHub/Vercel/Project Hub evidence. This does not authorize a new merge, Production deployment, Supabase apply, secret change, Auth activation, real source connection or geometry publication.
...
Historical PR #97 browser/accessibility evidence, including head `80645d64662699bd646f96718d300df5d2b84f5f`, remains preserved as scoped containment evidence. The prior historical snapshot is PR #106 / `cc8f9ebcf3989fab4a3c4eac9be9dfb8da786a7b` / `dpl_6RC2ohEdLBjiV82k758tFMkaDB9X`, with Quality Gate `29835520415` and artifacts `8497283837` / `8497226028`; these exact CI and deployment facts are historical, not the current release tuple. Real email/phone/RLS/Admin/Storage/source personas, field Core Web Vitals and live development apply remain open.
...
Immediate released-runtime restriction: PR #97 containment and subsequent public-funnel/release-truth corrections are released, but the public demo remains browser-local and fixture-bounded. Do not enter confidential, regulated, sensitive or client-protected AOIs, CSV, GeoJSON, filenames, evidence or dynamic package data. Protected persistence and real sources remain blocked.

## Topic navigation

### Confluence operational map

POINT_TO_OBJECT_001 V6 has not been read back from or written to Confluence in this iteration. The repository is the only reconciled V6 record at this stage; Hub parity remains unverified pending separate authorization and exact-page read-back.
...
- Current point-to-object development candidate: [V6 umbrella Change Request](change-requests/point-to-object-001/experience-v6/POINT_TO_OBJECT_001_V6_UMBRELLA_CHANGE_REQUEST.md), [integrated backlog/gates](change-requests/point-to-object-001/experience-v6/POINT_TO_OBJECT_001_V6_INTEGRATED_BACKLOG.md) and [exact A-head Preview receipt](change-requests/point-to-object-001/experience-v6/RELEASE_POINT_TO_OBJECT_001_V6_PREVIEW_RECEIPT_20260904.md). This is protected-Preview authority only and does not supersede released-runtime truth.
