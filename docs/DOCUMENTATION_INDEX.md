...
| POINT_TO_OBJECT_001 V5.1 candidate | [V5.1 Change Request](change-requests/point-to-object-001/experience-v5/POINT_TO_OBJECT_001_V5_1_INTERACTION_FIND_PROFILE_CHANGE_REQUEST.md) and [exact Preview receipt](change-requests/point-to-object-001/experience-v5/RELEASE_POINT_TO_OBJECT_001_V5_1_PREVIEW_RECEIPT_20260904.md) | Exact code head, Ready protected Preview and fully green Quality Gate recorded; founder manual acceptance pending; not merged or released |
...
| POINT_TO_OBJECT_001 V5.1 candidate | Branch `codex/point-to-object-clickable-prototype-v1` and open Draft PR #147 carry verified code head `789b197e4dcd3dbd03fc3d4aa594bdcb23ab1794`. Protected Preview `dpl_EjHRrkghsrPFXCZZc4cnQWbxWXRa` is Ready and Quality Gate `33878620781` passed both jobs, including V5 Chrome `1/1`, Auth/session Chrome `35/35`, build/API smoke and database replay. Founder manual acceptance remains pending in the [receipt](change-requests/point-to-object-001/experience-v5/RELEASE_POINT_TO_OBJECT_001_V5_1_PREVIEW_RECEIPT_20260904.md). It is not merged or Production-active; released source pack count-only/disabled, `main`, Production and hosted Supabase unchanged |
