...
- Last fully evidenced audit Preview: `dpl_CY7oNavQwu5ddkhRRLaR3FWTd3d9`, READY on exact evidence head `e999c5a07d3ced6c95f2eb44f6a5f03a9c17caea` at [geoai-oni3o8lwu-geoaidev.vercel.app](https://geoai-oni3o8lwu-geoaidev.vercel.app). The newer Auth evidence-control Preview `dpl_2YXvVKVHox3YTCwcm7oe3mhC4MNV` is healthy on exact head `0f22f4c194b422f12ab1e65b14d3577e4de11341`; the responsive functional Preview is rejected as recorded above. The exact accessibility/deep-keyboard Preview `dpl_HhpTExvknfLRhMNqxXunUvXZQorF` is healthy on `5d7af89ac2ead5b4df545e2f1810d5966c22cd0e`. Mock Auth, responsive entry and the first Workspace analysis-to-print keyboard/Axe slice are browser-proven; Projects/Explore Axe, comparison/project journeys, Lighthouse/Core Web Vitals and real-user personas remain unclaimed.
