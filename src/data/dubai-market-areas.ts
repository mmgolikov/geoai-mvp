...
const commonLimitations = [
  "Market context is illustrative local/public-open screening context and not official market evidence.",
...
export const dubaiMarketAreas: MarketArea[] = [
  {
    ...
    source: "seed_demo",
    marketActivityLevel: metric("Market activity", "high", 91, "stable", "Illustrative prime mixed-use demand signal; official validation required."),
    ...
    accessibilityContext: metric("Accessibility", "high", 90, "stable", "Central access and transit context are represented as illustrative screening signals."),
  ...
  },
  {
    ...
    source: "seed_demo",
    marketActivityLevel: metric("Market activity", "high", 86, "rising", "Illustrative commercial and residential context with assumed investor interest."),
  ...
  },
  {
    ...
    source: "seed_demo",
    marketActivityLevel: metric("Market activity", "high", 84, "stable", "Illustrative waterfront end-user and rental signal; official validation required."),
  ...
  },
  {
    ...
    transactionContext: metric("Transaction context", "high", 78, "rising", "Transaction depth is assumed; official DLD evidence is not connected in the current runtime."),
    ...
    accessibilityContext: metric("Accessibility", "medium", 72, "stable", "Road access and district amenities are positive illustrative screening signals."),
  ...
  },
  {
    ...
    developmentPipelineContext: metric("Development pipeline", "high", 84, "rising", "Pipeline and phasing are strong illustrative context signals."),
  ...
  },
  {
    ...
    accessibilityContext: metric("Accessibility", "high", 82, "stable", "Transit, creek, port, and road context are strong illustrative screening signals."),
  ...
  },
  {
    ...
    developmentPipelineContext: metric("Development pipeline", "high", 80, "rising", "Corridor development and infrastructure potential are strong illustrative context signals."),
