...
export const knownLimitations: KnownLimitation[] = [
  {
    ...
    whatExists: "Report package builder, local/API fallback repository, package APIs, printable package route, JSON export and appendices for source lineage, validation governance, evidence review, Data Room and validation workflow.",
    ...
    nextAction: "Use browser Print / Save as PDF, then add server-side rendering and durable document storage if required by a controlled client engagement.",
  ...
  },
  {
    ...
    nextAction: "Add a server-side PDF renderer if required by controlled client engagements or procurement workflows.",
  ...
  },
  {
    ...
    currentStatus: "foundation_ready",
    whatExists: "Repository adapters and review-draft migration/containment artifacts exist; public-access user state is browser-local.",
  ...
  },
  {
    ...
    currentStatus: "foundation_ready",
    whatExists: "Explicit public-access read allowlist, browser-local user artifacts and global early denial of shared server mutations.",
    ...
    caveat: "Browser-local public access is not authentication; selecting an Auth environment mode is not identity evidence.",
  ...
  },
  {
    ...
    whatExists: "DLD / Dubai Pulse local snapshot ingestion and source lineage.",
    ...
    caveat: "Current DLD context is manual/local snapshot context only; it is not a live official integration.",
