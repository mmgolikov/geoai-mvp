...
export const POINT_OBJECT_FIND_CAPABILITIES: Record<ExploreScenarioId, PointObjectFindCapability> = {
  b2c_point_context: {
    status: "supported", defaultGroup: "retail", allowedGroups: ALL_GROUPS,
    limitation: {
  ...
  b2c_tourist_objects_route: {
    status: "partial", defaultGroup: "civic_culture", allowedGroups: ["hospitality", "retail", "civic_culture"],
    limitation: {
  ...
  b2c_residential_context: {
    status: "supported", defaultGroup: "residential", allowedGroups: ["residential", "education", "healthcare", "retail"],
    limitation: {
  ...
  b2c_new_residential_projects: {
    status: "partial", defaultGroup: "construction", allowedGroups: ["construction", "residential"],
    limitation: {
  ...
  b2c_interest_routes: {
    status: "partial", defaultGroup: "civic_culture", allowedGroups: ["civic_culture", "retail", "hospitality"],
    limitation: {
  ...
  b2b_redevelopment_selected_aoi: {
    status: "partial", defaultGroup: "construction", allowedGroups: ["construction", "industrial_logistics", "residential", "commercial_office"],
    limitation: {
  ...
  b2b_redevelopment_100ha: {
    status: "unsupported", defaultGroup: "construction", allowedGroups: ["construction"],
    limitation: {
  ...
  b2b_lowrise_luxury_residential: {
    status: "partial", defaultGroup: "residential", allowedGroups: ["residential"],
    limitation: {
  ...
  b2b_hotel_development: {
    status: "partial", defaultGroup: "hospitality", allowedGroups: ["hospitality", "retail", "civic_culture"],
    limitation: {
  ...
  b2b_commercial_real_estate: {
    status: "partial", defaultGroup: "commercial_office", allowedGroups: ["commercial_office", "retail", "hospitality"],
    limitation: {
