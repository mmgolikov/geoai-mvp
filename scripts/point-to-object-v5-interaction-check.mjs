...
assert.match(findDrawer, /data-testid=\{`find-audience-\$\{audience\}`\}/);
...
assert.doesNotMatch(findDrawer, /More criteria|Дополнительные критерии|aria-expanded=\{findContextOpen\}/, "B2B/B2C, role, scenario and wired settings must be visible without a disclosure");
