...
// Sprint07 changes only the Workspace destination; the legacy page remains
// directly addressable, but must not be the canonical navigation destination.
for (const href of ["/prototype/point-to-object", "/projects"]) expect(navigation.includes(`href: "${href}"`), `Missing ${href} navigation.`);
expect(!navigation.includes('href: "/workspace"'), "Legacy workspace must not return as the canonical destination.");
