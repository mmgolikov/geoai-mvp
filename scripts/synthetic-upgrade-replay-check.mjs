...
if (pending.length !== 3) {
  failures.push(`Expected exactly three review-only pending migrations; found ${pending.length}`);
}
...
runSupabase(["migration", "up", "--local"], "Apply the three review-only pending migrations locally");
