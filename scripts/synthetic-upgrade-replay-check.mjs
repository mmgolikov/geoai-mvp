...
if (pending.length !== 10) {
  failures.push(`Expected exactly ten historical-baseline pending migrations; found ${pending.length}`);
}
...
runSupabase(["migration", "up", "--local", "--include-all"], "Apply all ten candidate migrations after the historical baseline locally, including the seven 20260716 version holes");
