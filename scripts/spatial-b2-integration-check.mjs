...
assert(explorePage.includes('redirect("/prototype/point-to-object")') && !explorePage.includes("WorkspaceShell"), "Explore compatibility entry must redirect to current Analyse/Find/Create without duplicating the spatial shell");
