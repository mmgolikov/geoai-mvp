...
Auth-rehearsal Preview `dpl_66rk4tVny9TmPjo7BKona5Xo1p1b` is READY on exact candidate head `8e0039260f4cf201b230288b6b02c48d2955600e`; Quality Gate run `29534323096` passed. Hosted HTTP evidence proves hard `supabase_auth`, public-demo denial and no synthetic anonymous identity, closing ENV-01 for non-Production Preview integration. Real email/MFA/Admin/rendered-browser personas remain unclaimed; never relabel HTTP smoke as browser evidence.
