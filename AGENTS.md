...
Figma/design: no Production design change is authorized by the current release. CR 10.02 authorizes only the bounded Product System v3.2 token/shared-shell candidate on `design/cr-10-02-foundation-shared-shell`; it excludes page-body migration, Page 90/Page 99, Figma/Code Connect writes, merge and Production. See `docs/CR_10_02_DESIGN_FOUNDATION_SHARED_SHELL.md` and GitHub issue #110.
