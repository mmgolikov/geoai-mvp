...
Last externally verified `main` snapshot: `7f323c4227f2409f3fe2d4d68be48a30176f4e2a` (`Merge PR #113: Product System v3.2.2 correction`).
Last externally verified Production snapshot: deployment `dpl_4yBHCo1eZ7N6GYQWGAg1EdQGwFTE`, READY at https://geoai-a71p4fxnr-geoaidev.vercel.app; aliases include https://geoai-mvp.vercel.app.
...
Historical PR #106 release evidence remains preserved in the active release documents and is not the current runtime tuple.
Released-runtime boundary: PR #97 containment and subsequent public-funnel/release-truth fixes are released, but the public demo remains browser-local and fixture-bounded. Never enter or upload confidential, regulated, sensitive or client-protected information. Protected persistence, real sources and confidential pilot operation remain blocked.
