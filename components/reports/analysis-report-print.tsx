    ...
    <article className="geoai-print-report">
      <PrintPage>
        ...
        <div className="geoai-print-meta-grid">
          <PrintCard label="Selected target" value={targetLabel} />
          <PrintCard label="Scenario" value={report.scenario} />
          <PrintCard label="Suitability" value={suitabilityScore} />
          <PrintCard label="Decision posture" value={decisionPosture} />
          <PrintCard label="Confidence" value={confidenceLabel} />
          <PrintCard label="Validation state" value="Validation required" />
        ...
        <div className="geoai-print-top-grid">
          <PrintSection title="Map Context / Selected Geometry">
            <ReportPrintMap
              title={targetLabel}
              subtitle="Object / AOI screening context"
            ...
            />
            <p className="geoai-print-note">Print-safe schematic context rendered from the current object/AOI and coordinates; official validation required.</p>
          </PrintSection>
