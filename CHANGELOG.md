...
- The branch remains an open Draft Preview candidate. Exact integrated-head CI, protected Preview evidence, founder manual acceptance, any V6.1 runtime contract adapter or generator spike, merge and Production release remain pending. No hosted Supabase, Auth/RLS/Storage, source, secret/environment, Figma, Confluence, `main` or Production mutation is included.
